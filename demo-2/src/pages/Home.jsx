...
const HomePage = () => {
  ...
  // Updated to match your exact CSS background requirement
  const heroStyle = {
    ...
    <>
      ...
      <header className="hero" style={heroStyle}>
        <div className="hero-text">
          ...
          <div style={{ background: '#b8c3da', color: '#7b7878', padding: '0', marginTop: '1.5rem', fontFamily: 'Arial, sans-serif', textAlign: 'center', display: 'block', clear: 'both' }}>
            <marquee behavior="scroll" direction="left" scrollamount="5" style={{ fontSize: '1.2rem', fontWeight: 'bold' }}>
      ...
      <main className="container">
        {/* Services Section - Identical nesting for CSS selectors */}
        ...
        {/* Featured Works Gallery - Identical nesting */}
        ...
        <section className="about-us" aria-labelledby="about-us-title">
          ...
          <p>
            {aboutData ? aboutData.description_top : "With over 10 years of experience, Addis Photo & Media Agency offers professional photography and videography services across Addis Ababa and beyond. Our expert team ensures you get memorable, high-quality images."}
          </p>
          <p>
          ...
          <div className="contact-info">
            <div className="contact-item location">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" focusable="false" className="icon location-icon" fill="currentColor" width="24" height="24">
                <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5a2.5 2.5 0 110-5 2.5 2.5 0 010 5z"/>
              </svg>
              <div className="contact-text">
                <span className="contact-label">Studio Location</span>
                <a href={aboutData ? aboutData.google_maps_link : "https://www.google.com/maps/search/?api=1&query=Addis+Ababa+Institute+of+Technology,5+Kilo,Addis+Ababa"}
                   target="_blank" rel="noopener noreferrer" aria-label="View studio location on Google Maps" className="contact-link">
            ...
            <div className="contact-item phone">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" focusable="false" className="icon phone-icon" fill="currentColor" width="24" height="24">
            ...
            <div className="contact-item email">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" focusable="false" className="icon email-icon" fill="currentColor" width="24" height="24">
